    ...
    <>
      ...
      <div className="a-root">
        ...
        <div className={`a-wrap${mounted ? ' ready' : ''}`}>
          ...
          {/* INTEGRAT BUTONUL NOU DE GOOGLE OAUTH SUB FORMULAR — cu loading state */}
          <button type="button" onClick={handleGoogleLogin} disabled={googleLoading} className="a-btn-google" aria-busy={googleLoading}>
            {googleLoading ? (
              <>
                <svg className="a-btn-google-spinner" viewBox="0 0 24 24" width="19" height="19" fill="none">
